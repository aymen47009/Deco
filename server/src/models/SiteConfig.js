...
const siteConfigSchema = new mongoose.Schema(
  {
    ...
    heroTitle: { type: String, default: 'ألواح جدارية احترافية' },
    ...
    sectionTitle: { type: String, default: 'نموذج طلب' },
    sectionSubtitle: { type: String, default: 'املأ النموذج وسنتواصل معك في أقرب وقت' },
